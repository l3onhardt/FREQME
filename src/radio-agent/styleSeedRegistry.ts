...
const KNOWN_QUERY_TRACK_KEYS: Record<string, string> = {
  [normalizeMatchText("frank ocean pinkpuss")]: "frankocean::pinkwhite",
  [normalizeMatchText("Frank Ocean Pink + White")]: "frankocean::pinkwhite",
    ...
    seedGroups: [
      {
        ...
        queryKeys: [
          ...
          queryKey("SZA Snooze"),
          queryKey("Giveon Heartbreak Anniversary"),
          queryKey("Miguel Adorn"),
          queryKey("The Internet Girl"),
          queryKey("Sonder Too Fast"),
          queryKey("Jorja Smith Blue Lights"),
          queryKey("Ravyn Lenae Skin Tight"),
          queryKey("Snoh Aalegra I Want You Around"),
          queryKey("PARTYNEXTDOOR Recognize"),
          queryKey("Usher Climax"),
          queryKey("D'Angelo Untitled"),
        ],
        cooldownTracks: 8,
      },
    ],
